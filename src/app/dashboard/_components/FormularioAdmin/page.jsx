...
export default function Page() {
  ...
  const filteredAdministradores = administradores.filter(administrador =>
    ...
    administrador.descripcion.toLowerCase().includes(searchTerm.toLowerCase()) ||
    administrador.ubicacion.toLowerCase().includes(searchTerm.toLowerCase()) ||
    administrador.contacto.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  const handleSubmit = (event) => {
    ...
    const { nombre, descripcion, ubicacion, contacto } = event.target.elements;
    const updatedData = {
      nombre: nombre.value,
    ...
    <div>
        ...
        <tbody className='text-center'>
          {currentData.map((administrador, index) => (
            <tr key={administrador._id} className='h-14 border-y-2'>
              ...
              <td>{administrador.ubicacion}</td>
              <td>{administrador.contacto}</td>
              <td>
                <button
          ...
          <div className="bg-white p-8 rounded-lg">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                <input type="email" name="correo" defaultValue={administradorSeleccionado.correo} className="p-2 border rounded w-full" />
              </div>
      ...
      {isModalOpenVer && administradorVer && (
         ...
         <div className="bg-white p-8 rounded-lg">
           ...
           <form>
           <img className='w-60 h-40 rounded-xl' src={administradorVer.foto_perfil} alt={administradorVer.nombre} />
             <div className="mb-4">
               <label className="block mb-2">Nombre:</label>
