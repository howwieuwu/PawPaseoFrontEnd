...
function LoginPage() {
    ...
    const handleLogin = async (e) => {
        ...
        setError('');
        try {
            const response = await axios.post('https://prueba-backend-phi.vercel.app/admin/login', {
                identifier , 
                password,
    ...
    return (
        <main className="flex flex-col md:flex-row items-center max-xl:w-full max-h-screen overflow-hidden">
            ...
            <section className="max-md:w-1/2 max-sm:w-full max-lg:w-1/2 max-xl:w-1/2 max-2xl:w-1/2 2xl:w-1/2 max-sm:mt-32 bg-gray-50">
                <div className=" max-xl:w-full">
                    ...
                    <div className="flex justify-center mt-4">
                        <Image src={Paw} width={264} height={121} className="max-sm:h-[20vh] 2xl:h-[25vh] max-xl:h-[30vh] max-lg:h-[20vh]" />
                    </div>
                    <form onSubmit={handleLogin} className="px-4 md:px-14 py-8 max-xl:w-full">
                        ...
                        <h5 className="text-center">¿No tienes una cuenta? <u onClick={setIsModalOpen}>Regístrate</u></h5>
            ...
            <section className="max-md:w-1/2 max-sm:w-1/2 max-lg:w-1/2 max-xl:w-1/2 max-2xl:w-1/2 2xl:w-1/2 h-full max-sm:hidden bg-gray-100">
                <Image src={Girl} width={756} height={500} className="w-full object-cover" />
            </section>
                ...
                <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
                    <div className="bg-[url('/image/INGRESOfondo.png')] p-4 rounded-lg">
                        <div className="flex justify-center text-center mt-4">
                            <div>
                                <Image src={Paw} width={264} height={121} className="max-sm:h-[20vh] 2xl:h-[25vh] max-xl:h-[30vh] max-lg:h-[20vh] pl-6" alt="Paw" />
